...
HEXAGON_HEIGHT = 0.762

HEXAGON_WIDTH = 0.8799

HEXAGON_SIDE_LENGTH = 0.4399

HEXAGON_TAPE_SIDE_LENGTH = 0.4985

TAPE_WIDTH = 0.0508

POWER_PORT_POINTS = np.array([
    [TAPE_WIDTH + HEXAGON_WIDTH / 2, 0],
    [HEXAGON_WIDTH / 2, 0],
    [HEXAGON_TAPE_SIDE_LENGTH / 2, -(HEXAGON_HEIGHT / 2 + TAPE_WIDTH)],
    [HEXAGON_WIDTH / 2, HEXAGON_HEIGHT / 2],
    [HEXAGON_WIDTH / 2, -HEXAGON_HEIGHT / 2],
    [-HEXAGON_WIDTH / 2, HEXAGON_HEIGHT / 2],
    [-HEXAGON_WIDTH / 2, -HEXAGON_HEIGHT / 2],
    [-HEXAGON_TAPE_SIDE_LENGTH / 2, -(HEXAGON_HEIGHT / 2 + TAPE_WIDTH)],
