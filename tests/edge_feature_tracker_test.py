...
xoutEdgeLeft.setStreamName("edge_left")
xoutEdgeRight.setStreamName("edge_right")
xinEdgeCfg.setStreamName("edge_cfg")
...
edgeDetectorLeft.outputImage.link(featureTrackerLeft.inputImage)
featureTrackerLeft.passthroughInputImage.link(xoutPassthroughFrameLeft.input)
featureTrackerLeft.outputFeatures.link(xoutTrackedFeaturesLeft.input)
xinTrackedFeaturesConfig.out.link(featureTrackerLeft.inputConfig)

monoRight.out.link(edgeDetectorRight.inputImage)
edgeDetectorRight.outputImage.link(featureTrackerRight.inputImage)
...
with dai.Device(pipeline) as device:
    ...
    edgeCfgQueue = device.getInputQueue("edge_cfg")
    ...
    # sobelHorizontalKernel = [[1, 0, -1],
    #                          [2, 0, -2],
    #                          [1, 0, -1]]
    # sobelVerticalKernel = [[1, 2, 1],
    #                        [0, 0, 0],
    #                        [-1, -2, -1]]
    # sobelHorizontalKernel = [[3, 0, -3],
    #                          [10, 0, -10],
    #                          [3, 0, -3]]
    # sobelVerticalKernel = [[3, 10, 3],
    #                        [0, 0, 0],
    #                        [-3, -10, -3]]
